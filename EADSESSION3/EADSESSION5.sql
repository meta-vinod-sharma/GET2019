...
insert into user(email,password) values('vinodsharma2598@gmail.com','pass');
insert into user(email,password) values('bhupendra.kumawat@gmail.com','pass');
insert into user(email,password) values('surender.sengwa@gmail.com','pass');
insert into user(email,password) values('vinay.pancholi@gmail.com','pass');
